...
SELECT * FROM view_precipitacao_dados AS vp
WHERE vp.estacao_estado = 'SP'
AND vp.estacao_nome = 'SAO PAULO - INTERLAGOS'
AND vp.datahora_captacao BETWEEN (CAST('2022-01-21 10:00:00' AS TIMESTAMP) - INTERVAL '7 days') AND (CAST('2022-01-21 10:00:00' AS TIMESTAMP);
...
AND t.cod_wmo = 'A001'
AND t.datahora_captacao BETWEEN CAST('2022-01-15 10:00:00' AS TIMESTAMP) AND CAST('2022-01-21 10:00:00' AS TIMESTAMP);
